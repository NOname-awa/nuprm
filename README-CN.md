...
<h1 class="rainbow">NuPrm，优美的 Nushell 主题管理器！</h1>

<style>
  .rainbow {
    background: linear-gradient(
      to right, #ff9999, #ffcc99, #ffff99, #99ff99, #99ccff, #cc99ff, #ff99ff
    );
